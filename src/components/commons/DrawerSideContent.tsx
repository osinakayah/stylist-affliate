...
const DrawerSideContent: React.FC<DrawerSideContentProps> = (props) => {
    return (
        <div className={'side-drawer-container'}>
            ...
            <ul className={'side-menu-list'}>
                <li className={props.activeRoute==='/product'? 'active-link': ''}><Link to={'/product'} href={'/product'}>Products</Link></li>
                <li className={props.activeRoute==='/profile'? 'active-link': ''}><Link to={'/profile'} href={'/profile'}>Profile</Link></li>
            </ul>
        </div>
    );
}
