...
export default class VerifyAccount extends PureComponent<IProps, IState> {
    ...
    attemptVerify = async () => {
        ...
        const response = await AuthService.completeAccount({...payload, token,});
                                    ...
                                    <div style={{marginTop: '7%'}}>
                                        <Form className={'mb-3'}>
                                            ...
                                            <Form.Group >
                                                ...
                                                <Form.Control onChange={(event: any) => this.handleChange('accountName', event.target.value)} type="text" placeholder="アカウント名を入力してください" />
                                            </Form.Group>
                                            <Form.Group >
                                                <Form.Label>口座番号</Form.Label>
                                                <Form.Control onChange={(event: any) => this.handleChange('accountNumber', event.target.value)} type="text" placeholder="アカウント番号を入力してください" />
                                            </Form.Group>
                                            <AppButton onClick={this.attemptVerify} block buttonText={'完全な登録'} />
                                        </Form>
